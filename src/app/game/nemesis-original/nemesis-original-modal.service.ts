...
import { NoGameEndModalData, NogGameEndModalComponent } from '@common/components/nog-specific/nog-game-end-modal/nog-game-end-modal.component';
...
export class NemesisOriginalModalService {
    ...
    public openGameEndSummary(gameState: GameSetupDataOriginal, autodestructionHappened: boolean): Observable<boolean | undefined> {
