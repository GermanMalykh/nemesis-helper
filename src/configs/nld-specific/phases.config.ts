...
export type Stage = 'draw_cards' | 'first_player_transfer' | 'player_actions' | 'launch_css' | 'round_tracker_update' | 'noise_markers_removal' | 'monster_attack' | 'monster_fire_damage' | 'resolve_event_card' | 'monster_development';
